...
export const initialCalendarEvents: OrionCalendarEvent[] = [
  ...
  { id: "ev-2", title: "Client Call", account: "Acme Corporation", dayIndex: 0, startHour: 11, duration: 1, kind: "task", attendees: 4, location: "Zoom", notes: "Review proposal feedback and commercial next steps." },
  { id: "ev-3", title: "Demo Presentation", account: "Globex Inc.", dayIndex: 0, startHour: 14, duration: 1, kind: "call", attendees: 8, location: "Google Meet", notes: "Enterprise workflow demonstration." },
  { id: "ev-4", title: "Follow-up Call", account: "Wayne Enterprises", dayIndex: 0, startHour: 16, duration: .5, kind: "meeting", attendees: 3, location: "Phone", notes: "Confirm executive review participants." },
  { id: "ev-5", title: "Discovery Call", account: "Cyberdyne Systems", dayIndex: 1, startHour: 10, duration: 1, kind: "call", attendees: 5, location: "Teams", notes: "Document integration and reporting requirements." },
  ...
  { id: "ev-7", title: "Partnership Call", account: "Stark Industries", dayIndex: 1, startHour: 15.5, duration: 1, kind: "task", attendees: 4, location: "Zoom", notes: "Align on partnership operating model." },
  { id: "ev-8", title: "Proposal Discussion", account: "Umbrella Corp.", dayIndex: 2, startHour: 9.5, duration: 1, kind: "task", attendees: 4, location: "Google Meet", notes: "Walk through revised proposal." },
  ...
  { id: "ev-10", title: "Demo Walkthrough", account: "Initech", dayIndex: 2, startHour: 16, duration: 1, kind: "call", attendees: 6, location: "Teams", notes: "Implementation workflow walkthrough." },
  ...
  { id: "ev-12", title: "Client Call", account: "Massive Dynamic", dayIndex: 3, startHour: 11, duration: 1, kind: "meeting", attendees: 4, location: "Google Meet", notes: "Discuss procurement process." },
  { id: "ev-13", title: "Contract Review", account: "LexCorp", dayIndex: 3, startHour: 14, duration: 1, kind: "task", attendees: 3, location: "Teams", notes: "Resolve commercial redlines." },
  ...
  { id: "ev-15", title: "Lunch with Partner", account: "Pied Piper", dayIndex: 4, startHour: 13, duration: 1, kind: "review", attendees: 2, location: "The Atrium", notes: "Partnership relationship review." },
